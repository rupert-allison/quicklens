...
## RA addition
class library_flat_lensed_dust():
    """ a library which generates lensed CMB realizations with added dust realisation. """
    def __init__(self, pix, cl_unl, lib_dir, dust_dir, cmb=True, phase=None):
        """ initialize the library.
             ...
             dust_dir = directory of dust maps
